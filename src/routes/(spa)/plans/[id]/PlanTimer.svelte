...
<div class="w-full max-w-screen-md border rounded-lg border-gray-200 dark:border-gray-700 p-4 mt-4">
	<div class="flex flex-row">
		...
		<div class="w-full">
			<div class="flex flex-row pl-2 py-2 border border-gray-200"  ><strong class="mr-16 md:mr-20">Now:</strong><Clock /></div>

			<div class="border-t-2 border-x-2 border-gray-200 mt-2 bg-main-light dark:bg-main-dark py-2">
				<div class="pl-20 md:pl-60">
					{#if $darkModeStore}
						<img src="/hourglass-dark.png" alt="Hourglass" width="25" height="25" />
					{:else}
						<img src="/hourglass.webp" alt="Hourglass" width="25" height="25" />
					{/if}
				</div>
			</div>
			<div class="flex flex-row justify-between w-full">
				<div class="flex justify-center border-r-2 border-y-2 border-gray-200 w-1/2 md:w-3/4">
					<p class="flex justify-center w-full">
						<span class="flex flex-col justify-center w-full my-2 mr-2 pl-2 py-2 border border-gray-200">
			...
			<p class="border border-gray-200">
				<span class="flex flex-row mt-1 pl-2 py-2">
					<strong class="pr-2 md:pr-6">Target time:</strong>
